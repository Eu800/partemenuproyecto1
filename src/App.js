...
import SuppliesCRUD from './components/SuppliesCRUD';
    ...
    <div className="App">
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/login/updatePass" element={<ReestablecerContraseña  listaUsuarios={listaUsers} 
          setListaUsuarios={setListaUsers} listAdmin={admins}/>}/>
          <Route path="/menubrigadista/:user" element={<Menuizquierdo/>}/>
          <Route path="/menuAdmin/supplies" element={<SuppliesCRUD />}/>
        </Routes>
      </BrowserRouter>
    </div>
  );
